GITHUB_REPO := vigetlabs/terraform-aws-canary-heartbeat
FILES_TO_COMPRESS := templates/heartbeat.py.tftpl context.tf datasource.tf iam.tf main.tf outputs.tf s3.tf variables.tf versions.tf LICENSE
GITHUB_CLI := gh
